...
\begin{tabular}{cc}
      ...
      \includegraphics[width=70mm]{speedup_async_N20.png} & \includegraphics[width=70mm]{speedup_async_N40.png} \\
      \includegraphics[width=70mm]{speedup_async_N80.png} & \includegraphics[width=70mm]{speedup_async_N160.png} \\
\end{tabular}
...
Scalability follows closely the ideal curve up to 12 workers. 
Beyond 12 workers, the parallel efficiency drops to 55 \% (18 workers) and 45 \% 
(36 workers).
A likely reason for the diminished scalability above $12$ worker
is the cost of initializing a cohort ($1.6$ larger than the time it 
takes for a cohort to loop over all the steps). In this 
particular example, the MPI communicatinon cost remains modest for all 
worker counts ($< 2$ \% of the computational cost).
...
\begin{figure}
    ...
    with 36 age groups, 60 time steps and 96 cohorts.}
