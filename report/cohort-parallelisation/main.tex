...
\end{algorithm}
 ...
 and their dependencies. When a worker completes a step and sends a message to the manager, the manager checks if this completion satisfies any other tasks' prerequisites. If so, it can dispatch those tasks to available workers.
