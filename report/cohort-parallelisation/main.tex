...
describe a first scalability test, involving 36 age groups (96 cohorts) advanced over the period 1979-1983 (60 time steps). 
...
cohorts (or workers) but must go through the manager first. The rationale for this choice is to facilitate the implementation of parallelism
