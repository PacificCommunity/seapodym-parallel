...
Some preliminary investigations suggest that the flattening of the speedup curve is due to
...
\begin{figure}
    ...
    \caption{Parallel speedup relative to a single worker run for seapodym_cohort.}
